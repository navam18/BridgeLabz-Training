...
import com.training.contactdirectory.dto.ContactUpdateRequest;
...
public class ContactServiceImpl implements ContactService {
    ...
    public ContactResponse updateContact(Long id, ContactUpdateRequest request) {
        ...
        if (contactRepository.existsByPhoneNumberAndIdNot(request.getPhoneNumber(), id)) {
            throw new DuplicateContactException("Phone number already in use: " + request.getPhoneNumber());
        }
        if (contactRepository.existsByEmailAddressAndIdNot(request.getEmailAddress(), id)) {
            throw new DuplicateContactException("Email address already in use: " + request.getEmailAddress());
        }
